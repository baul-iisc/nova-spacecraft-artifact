...
extern const uint16_t softfloat_approxRecipSin_1k0s[];
extern const uint16_t softfloat_approxRecipSin_1k1s[];
...
uint64_t softfloat_approxRecipSin64_1( uint64_t a )
{
    ...
    index = a>>59 & 0xF;
    eps = (uint16_t) (a>>43);
    r0 = softfloat_approxRecipSin_1k0s[index]
             - ((softfloat_approxRecipSin_1k1s[index] * (uint_fast64_t) eps)>>20);
