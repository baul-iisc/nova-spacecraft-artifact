...
#define MASK_FATAN2_S  0xfe00007f
#define MATCH_FATAN2_D 0x4A000053
#define MASK_FATAN2_D  0xfe00007f
#define MATCH_FSIN_H 0x3C000053
#define MASK_FSIN_H  0xfff0007f
#define MATCH_FCOS_H 0x4C000053
#define MASK_FCOS_H  0xfff0007f
#define MATCH_FTAN_H 0x4E000053
#define MASK_FTAN_H  0xfff0007f
#define MATCH_FATAN2_H 0x50000053
#define MASK_FATAN2_H  0xfff0007f
...
#define MATCH_FATAN_H 0x52000053
#define MASK_FATAN_H  0xfff0007f
...
#define MATCH_FASIN_H 0x68000053
#define MASK_FASIN_H  0xfff0007f
#define MATCH_FACOS_H 0x6A000053
#define MASK_FACOS_H  0xfff0007f
/*#define MATCH_FATAN_Q 0x6C000053
#define MASK_FATAN_Q  0xfff0007f*/
/*#define MATCH_FATAN2_Q 0x6E000053
#define MASK_FATAN2_Q  0xfe00007f*/

/* NOVA CORDIC Pipeline Extended Operations (opcode = OP-FP = 0x53) */
/* Exponential */
#define MATCH_FEXP_S  0x6C000053
#define MASK_FEXP_S   0xfff0007f
#define MATCH_FEXP_D  0x6E000053
#define MASK_FEXP_D   0xfff0007f
/* Logarithm */
#define MATCH_FLOG_S  0x70000053
#define MASK_FLOG_S   0xfff0007f
#define MATCH_FLOG_D  0x72000053
#define MASK_FLOG_D   0xfff0007f
/* Hyperbolic Sine */
#define MATCH_FSINH_S 0x74000053
#define MASK_FSINH_S  0xfff0007f
#define MATCH_FSINH_D 0x76000053
#define MASK_FSINH_D  0xfff0007f
/* Hyperbolic Cosine */
#define MATCH_FCOSH_S 0x78000053
#define MASK_FCOSH_S  0xfff0007f
#define MATCH_FCOSH_D 0x7A000053
#define MASK_FCOSH_D  0xfff0007f
/* Hyperbolic Tangent */
#define MATCH_FTANH_S 0x7C000053
#define MASK_FTANH_S  0xfff0007f
#define MATCH_FTANH_D 0x7E000053
#define MASK_FTANH_D  0xfff0007f
/* Hypotenuse (binary: hypot(rs1, rs2)) */
#define MATCH_FHYPOT_S 0x80000053
#define MASK_FHYPOT_S  0xfe00007f
#define MATCH_FHYPOT_D 0x82000053
#define MASK_FHYPOT_D  0xfe00007f
...
/* Custom NOVA Processor Matrix Extension Instructions (opcode = custom-3 = 0x77) */
/* Matrix Memory Load/Store (Single Precision) */
#define MATCH_ML        0x22000077
#define MASK_ML         0xfff0707f
#define MATCH_MS        0x22001077
#define MASK_MS         0xfff0707f
#define MATCH_MLS       0x22004077
#define MASK_MLS        0xfe00707f
#define MATCH_MSS       0x22005077
#define MASK_MSS        0xfe00707f

/* Matrix Memory Load/Store (Double Precision) */
#define MATCH_MLD       0x22002077
#define MASK_MLD        0xfff0707f
#define MATCH_MSD       0x22003077
#define MASK_MSD        0xfff0707f
#define MATCH_MLDS      0x22006077
#define MASK_MLDS       0xfe00707f
#define MATCH_MSDS      0x22007077
#define MASK_MSDS       0xfe00707f

/* Matrix Move */
#define MATCH_MMV_XMU   0x42100077
#define MASK_MMV_XMU    0xfff0707f

/* Matrix MAC/Add/Sub (Unsigned Integer) */
#define MATCH_MMACU     0x62000077
#define MASK_MMACU      0xfe00707f
#define MATCH_MADDU     0x62001077
#define MASK_MADDU      0xfe00707f
#define MATCH_MSUBU     0x62002077
#define MASK_MSUBU      0xfe00707f

/* Matrix MAC/Add/Sub (Signed Integer) */
#define MATCH_MMAC      0x66000077
#define MASK_MMAC       0xfe00707f
#define MATCH_MADD_M    0x66001077
#define MASK_MADD_M     0xfe00707f
#define MATCH_MSUB_M    0x66002077
#define MASK_MSUB_M     0xfe00707f

/* Matrix MAC/Add/Sub (Single Precision Float) */
#define MATCH_MMACF     0x6a000077
#define MASK_MMACF      0xfe00707f
#define MATCH_MADDF     0x6a001077
#define MASK_MADDF      0xfe00707f
#define MATCH_MSUBF     0x6a002077
#define MASK_MSUBF      0xfe00707f

/* Matrix MAC/Add/Sub (Double Precision) */
#define MATCH_MMACD     0x66002077
#define MASK_MMACD      0xfe00707f
#define MATCH_MMACDF    0x6a003077
#define MASK_MMACDF     0xfe00707f
#define MATCH_MADDD     0x66003077
#define MASK_MADDD      0xfe00707f
#define MATCH_MADDFD    0x6a004077
#define MASK_MADDFD     0xfe00707f
#define MATCH_MSUBD     0x66004077
#define MASK_MSUBD      0xfe00707f
#define MATCH_MSUBFD    0x6a005077
#define MASK_MSUBFD     0xfe00707f

/* Accumulator Operations */
#define MATCH_MACC_ZERO   0x80000077
#define MASK_MACC_ZERO    0xfffff07f
#define MATCH_MACC_MOVE   0x80001077
#define MASK_MACC_MOVE    0xfff0707f
#define MATCH_MACC_STORE  0x80002077
#define MASK_MACC_STORE   0xfff0707f
#define MATCH_MACC_ZEROF  0x80003077
#define MASK_MACC_ZEROF   0xfffff07f
#define MATCH_MACC_ZEROD  0x80004077
#define MASK_MACC_ZEROD   0xfffff07f

/* Matrix-Vector Operations */
#define MATCH_MV_LOAD     0x82000077
#define MASK_MV_LOAD      0xfe00707f
#define MATCH_MV_STORE    0x82001077
#define MASK_MV_STORE     0xfe00707f
#define MATCH_MV_MUL      0x86002077
#define MASK_MV_MUL       0xfe00707f
#define MATCH_MV_MAC      0x86003077
#define MASK_MV_MAC       0xfe00707f
#define MATCH_MV_MAC_ACC  0x86006077
#define MASK_MV_MAC_ACC   0xfe00707f

/* Accumulator-Based Multiply-Accumulate */
#define MATCH_MMACF_ACC   0x6a006077
#define MASK_MMACF_ACC    0xfe00707f
#define MATCH_MMACDF_ACC  0x6a007077
#define MASK_MMACDF_ACC   0xfe00707f

/* Matrix Inversion */
#define MATCH_MINVF       0x6a005077
#define MASK_MINVF        0xfff0707f
#define MATCH_MINVD       0x6a006077
#define MASK_MINVD        0xfff0707f

/* Systolic Array Control */
#define MATCH_SYS_CONFIG    0xa2000077
#define MASK_SYS_CONFIG     0xfff07fff
#define MATCH_SYS_START     0xa2001077
#define MASK_SYS_START      0xffffffff
#define MATCH_SYS_STOP      0xa2002077
#define MASK_SYS_STOP       0xffffffff
#define MATCH_SYS_STATUS    0xa2003077
#define MASK_SYS_STATUS     0xfffff07f

/* Systolic Array Data (Single Precision) */
#define MATCH_SYS_LOAD_A    0xa2004077
#define MASK_SYS_LOAD_A     0xfe00707f
#define MATCH_SYS_LOAD_B    0xa2005077
#define MASK_SYS_LOAD_B     0xfe00707f
#define MATCH_SYS_LOAD_C    0xa2006077
#define MASK_SYS_LOAD_C     0xfe00707f
#define MATCH_SYS_STORE_C   0xa2007077
#define MASK_SYS_STORE_C    0xfe00707f

/* Systolic Array Data (Double Precision) */
#define MATCH_SYS_LOAD_AD   0xa6004077
#define MASK_SYS_LOAD_AD    0xfe00707f
#define MATCH_SYS_LOAD_BD   0xa6005077
#define MASK_SYS_LOAD_BD    0xfe00707f
#define MATCH_SYS_LOAD_CD   0xa6006077
#define MASK_SYS_LOAD_CD    0xfe00707f
#define MATCH_SYS_STORE_CD  0xa6007077
#define MASK_SYS_STORE_CD   0xfe00707f

/* Systolic Array Multiply-Accumulate */
#define MATCH_SYS_MMAC      0xb2000077
#define MASK_SYS_MMAC       0xfe00707f
...
DECLARE_INSN(fasin_s, MATCH_FASIN_S, MASK_FASIN_S)
DECLARE_INSN(facos_s, MATCH_FACOS_S, MASK_FACOS_S)
DECLARE_INSN(ftan_s, MATCH_FTAN_S, MASK_FTAN_S)
DECLARE_INSN(fatan_s, MATCH_FATAN_S, MASK_FATAN_S)
DECLARE_INSN(fatan2_s, MATCH_FATAN2_S, MASK_FATAN2_S)
DECLARE_INSN(fsin_d, MATCH_FSIN_D, MASK_FSIN_D)
DECLARE_INSN(fcos_d, MATCH_FCOS_D, MASK_FCOS_D)
DECLARE_INSN(fasin_d, MATCH_FASIN_D, MASK_FASIN_D)
DECLARE_INSN(facos_d, MATCH_FACOS_D, MASK_FACOS_D)
DECLARE_INSN(ftan_d, MATCH_FTAN_D, MASK_FTAN_D)
DECLARE_INSN(fatan_d, MATCH_FATAN_D, MASK_FATAN_D)
DECLARE_INSN(fatan2_d, MATCH_FATAN2_D, MASK_FATAN2_D)
/* NOVA CORDIC Pipeline Extended Instructions */
DECLARE_INSN(fexp_s, MATCH_FEXP_S, MASK_FEXP_S)
DECLARE_INSN(fexp_d, MATCH_FEXP_D, MASK_FEXP_D)
DECLARE_INSN(flog_s, MATCH_FLOG_S, MASK_FLOG_S)
DECLARE_INSN(flog_d, MATCH_FLOG_D, MASK_FLOG_D)
DECLARE_INSN(fsinh_s, MATCH_FSINH_S, MASK_FSINH_S)
DECLARE_INSN(fsinh_d, MATCH_FSINH_D, MASK_FSINH_D)
DECLARE_INSN(fcosh_s, MATCH_FCOSH_S, MASK_FCOSH_S)
DECLARE_INSN(fcosh_d, MATCH_FCOSH_D, MASK_FCOSH_D)
DECLARE_INSN(ftanh_s, MATCH_FTANH_S, MASK_FTANH_S)
DECLARE_INSN(ftanh_d, MATCH_FTANH_D, MASK_FTANH_D)
DECLARE_INSN(fhypot_s, MATCH_FHYPOT_S, MASK_FHYPOT_S)
DECLARE_INSN(fhypot_d, MATCH_FHYPOT_D, MASK_FHYPOT_D)
/*DECLARE_INSN(fsin_q, MATCH_FSIN_Q, MASK_FSIN_Q)
DECLARE_INSN(fcos_q, MATCH_FCOS_Q, MASK_FCOS_Q)
DECLARE_INSN(ftan_q, MATCH_FTAN_Q, MASK_FTAN_Q)
DECLARE_INSN(fatan2_q, MATCH_FATAN2_Q, MASK_FATAN2_Q)*/
/* NOVA Matrix Extension Instructions */
DECLARE_INSN(ml, MATCH_ML, MASK_ML)
DECLARE_INSN(ms, MATCH_MS, MASK_MS)
DECLARE_INSN(mls, MATCH_MLS, MASK_MLS)
DECLARE_INSN(mss, MATCH_MSS, MASK_MSS)
DECLARE_INSN(mld, MATCH_MLD, MASK_MLD)
DECLARE_INSN(msd, MATCH_MSD, MASK_MSD)
DECLARE_INSN(mlds, MATCH_MLDS, MASK_MLDS)
DECLARE_INSN(msds, MATCH_MSDS, MASK_MSDS)
DECLARE_INSN(mmv_xmu, MATCH_MMV_XMU, MASK_MMV_XMU)
DECLARE_INSN(mmacu, MATCH_MMACU, MASK_MMACU)
DECLARE_INSN(mmac, MATCH_MMAC, MASK_MMAC)
DECLARE_INSN(mmacf, MATCH_MMACF, MASK_MMACF)
DECLARE_INSN(maddu, MATCH_MADDU, MASK_MADDU)
DECLARE_INSN(madd_m, MATCH_MADD_M, MASK_MADD_M)
DECLARE_INSN(maddf, MATCH_MADDF, MASK_MADDF)
DECLARE_INSN(msubu, MATCH_MSUBU, MASK_MSUBU)
DECLARE_INSN(msub_m, MATCH_MSUB_M, MASK_MSUB_M)
DECLARE_INSN(msubf, MATCH_MSUBF, MASK_MSUBF)
DECLARE_INSN(mmacd, MATCH_MMACD, MASK_MMACD)
DECLARE_INSN(mmacdf, MATCH_MMACDF, MASK_MMACDF)
DECLARE_INSN(maddd, MATCH_MADDD, MASK_MADDD)
DECLARE_INSN(maddfd, MATCH_MADDFD, MASK_MADDFD)
DECLARE_INSN(msubd, MATCH_MSUBD, MASK_MSUBD)
DECLARE_INSN(msubfd, MATCH_MSUBFD, MASK_MSUBFD)
DECLARE_INSN(macc_zero, MATCH_MACC_ZERO, MASK_MACC_ZERO)
DECLARE_INSN(macc_move, MATCH_MACC_MOVE, MASK_MACC_MOVE)
DECLARE_INSN(macc_store, MATCH_MACC_STORE, MASK_MACC_STORE)
DECLARE_INSN(macc_zerof, MATCH_MACC_ZEROF, MASK_MACC_ZEROF)
DECLARE_INSN(macc_zerod, MATCH_MACC_ZEROD, MASK_MACC_ZEROD)
DECLARE_INSN(mv_load, MATCH_MV_LOAD, MASK_MV_LOAD)
DECLARE_INSN(mv_store, MATCH_MV_STORE, MASK_MV_STORE)
DECLARE_INSN(mv_mul, MATCH_MV_MUL, MASK_MV_MUL)
DECLARE_INSN(mv_mac, MATCH_MV_MAC, MASK_MV_MAC)
DECLARE_INSN(mv_mac_acc, MATCH_MV_MAC_ACC, MASK_MV_MAC_ACC)
DECLARE_INSN(mmacf_acc, MATCH_MMACF_ACC, MASK_MMACF_ACC)
DECLARE_INSN(mmacdf_acc, MATCH_MMACDF_ACC, MASK_MMACDF_ACC)
DECLARE_INSN(minvf, MATCH_MINVF, MASK_MINVF)
DECLARE_INSN(minvd, MATCH_MINVD, MASK_MINVD)
DECLARE_INSN(sys_config, MATCH_SYS_CONFIG, MASK_SYS_CONFIG)
DECLARE_INSN(sys_start, MATCH_SYS_START, MASK_SYS_START)
DECLARE_INSN(sys_stop, MATCH_SYS_STOP, MASK_SYS_STOP)
DECLARE_INSN(sys_status, MATCH_SYS_STATUS, MASK_SYS_STATUS)
DECLARE_INSN(sys_load_a, MATCH_SYS_LOAD_A, MASK_SYS_LOAD_A)
DECLARE_INSN(sys_load_b, MATCH_SYS_LOAD_B, MASK_SYS_LOAD_B)
DECLARE_INSN(sys_load_c, MATCH_SYS_LOAD_C, MASK_SYS_LOAD_C)
DECLARE_INSN(sys_store_c, MATCH_SYS_STORE_C, MASK_SYS_STORE_C)
DECLARE_INSN(sys_load_ad, MATCH_SYS_LOAD_AD, MASK_SYS_LOAD_AD)
DECLARE_INSN(sys_load_bd, MATCH_SYS_LOAD_BD, MASK_SYS_LOAD_BD)
DECLARE_INSN(sys_load_cd, MATCH_SYS_LOAD_CD, MASK_SYS_LOAD_CD)
DECLARE_INSN(sys_store_cd, MATCH_SYS_STORE_CD, MASK_SYS_STORE_CD)
DECLARE_INSN(sys_mmac, MATCH_SYS_MMAC, MASK_SYS_MMAC)
DECLARE_INSN(sys_mmacd, MATCH_SYS_MMACD, MASK_SYS_MMACD)
