...
#undef DISASM_VECTOR_VV_VS
  ...
  {
    /* Matrix Memory Load/Store (Single Precision) */
    DEFINE_R1TYPE(ml);
    DEFINE_R1TYPE(ms);
    DEFINE_RTYPE(mls);
    DEFINE_RTYPE(mss);
    /* Matrix Memory Load/Store (Double Precision) */
    DEFINE_R1TYPE(mld);
    DEFINE_R1TYPE(msd);
    DEFINE_RTYPE(mlds);
    DEFINE_RTYPE(msds);
    ...
    /* Matrix MAC/Add/Sub (Unsigned Integer) */
    DEFINE_RTYPE(mmacu);
    DEFINE_RTYPE(maddu_m);
    DEFINE_RTYPE(msubu_m);
    /* Matrix MAC/Add/Sub (Signed Integer) */
    DEFINE_RTYPE(mmac);
    DEFINE_RTYPE(madd_m);
    DEFINE_RTYPE(msub_m);
    /* Matrix MAC/Add/Sub (Float) */
    DEFINE_RTYPE(mmacf);
    DEFINE_RTYPE(maddf);
    DEFINE_RTYPE(msubf);
