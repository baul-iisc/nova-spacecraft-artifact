 ...
 */
/*****************************************************************************
 * Fuel-Optimal Planetary Landing Algorithm — HW TRIG VARIANT
 *
 * Author : Boul Chandra Garai
 * Target : RISC-V (RV64GC) with Matrix Extension Accelerator
 * Variant: CORDIC trigonometric accelerator (sin/cos/tan/atan2 → HW)
...
// Hardware trigonometric function wrappers
// Mapped to CORDIC hardware accelerator instructions
