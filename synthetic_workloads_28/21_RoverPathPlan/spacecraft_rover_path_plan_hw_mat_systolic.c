...
static void hw_inverse_recursive(const double *A, double *R, int n) {
 ...
 int k = n / 2, rest = n - k;
 double w1[MATRIX_DIM*MATRIX_DIM], w2[MATRIX_DIM*MATRIX_DIM], w3[MATRIX_DIM*MATRIX_DIM];
 double Ai[MATRIX_DIM*MATRIX_DIM], S[MATRIX_DIM*MATRIX_DIM], Si[MATRIX_DIM*MATRIX_DIM];
