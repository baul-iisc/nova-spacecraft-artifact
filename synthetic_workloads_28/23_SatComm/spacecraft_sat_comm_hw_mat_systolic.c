 ...
 * Variant: HW Mat (AME 3x3 tile accelerator for matrix multiply)
...
// HW Mat variant: AME 3x3 tiled SYS_MMACD with float<->double conversion
void matrix_multiply_tiled(float A[MATRIX_SIZE][MATRIX_SIZE],
 float B[MATRIX_SIZE][MATRIX_SIZE],
 float C[MATRIX_SIZE][MATRIX_SIZE]) {
 ...
 double B_d[MATRIX_SIZE * MATRIX_SIZE];
